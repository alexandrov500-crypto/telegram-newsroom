...
set_env_kv PIPELINE_INTERVAL_MINUTES "${PIPELINE_INTERVAL_MINUTES:-5}"
set_env_kv BREAKING_LANE_INTERVAL_MIN "${BREAKING_LANE_INTERVAL_MIN:-1}"
set_env_kv PUBLISH_CHANNEL_MIN_INTERVAL_SEC "${PUBLISH_CHANNEL_MIN_INTERVAL_SEC:-45}"
...
set_env_kv PUBLISH_FLOOR_MAX_SILENCE_MIN "${PUBLISH_FLOOR_MAX_SILENCE_MIN:-22}"
...
set_env_kv SOURCE_COOLDOWN_MINUTES "${SOURCE_COOLDOWN_MINUTES:-4}"
...
set_env_kv NEWSROOM_PUBLISH_FORMAT "${NEWSROOM_PUBLISH_FORMAT:-format_ab}"
set_env_kv FORMAT_AB_EXPERIMENT_ENABLED "${FORMAT_AB_EXPERIMENT_ENABLED:-true}"
...
set_env_kv CHANNEL_PRODUCT_SHARE_NUDGE "${CHANNEL_PRODUCT_SHARE_NUDGE:-true}"
...
set_env_kv GROWTH_PEAK_HOUR_MODE "${GROWTH_PEAK_HOUR_MODE:-soft}"
