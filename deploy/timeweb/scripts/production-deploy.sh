...
set_env_kv WIRE_POST_INTEGRATED_CLOSURE "${WIRE_POST_INTEGRATED_CLOSURE:-false}"
set_env_kv WIRE_POST_WHY_BLOCK "${WIRE_POST_WHY_BLOCK:-true}"
set_env_kv PUBLISH_QUALITY_GATE_STRICT "${PUBLISH_QUALITY_GATE_STRICT:-true}"
set_env_kv WIRE_POST_BODY_MAX_CHARS "${WIRE_POST_BODY_MAX_CHARS:-1050}"
set_env_kv WIRE_POST_MIN_BODY_CHARS "${WIRE_POST_MIN_BODY_CHARS:-280}"
set_env_kv WIRE_POST_MAX_SENTENCES "${WIRE_POST_MAX_SENTENCES:-6}"
set_env_kv WIRE_POST_MIN_SENTENCES "${WIRE_POST_MIN_SENTENCES:-4}"
set_env_kv WIRE_POST_TARGET_CHARS_MIN "${WIRE_POST_TARGET_CHARS_MIN:-520}"
set_env_kv WIRE_POST_THESIS_BULLETS "${WIRE_POST_THESIS_BULLETS:-true}"
set_env_kv EDITORIAL_AUDIENCE_UNIFICATION_LAYER "${EDITORIAL_AUDIENCE_UNIFICATION_LAYER:-false}"
...
set_env_kv PUBLIC_WHY_IT_MATTERS "${PUBLIC_WHY_IT_MATTERS:-true}"
