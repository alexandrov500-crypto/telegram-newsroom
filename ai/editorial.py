    ...
    *,
    ...
    blocks.extend(
        [
            ...
            f"* post: 2–3 абзаца, 4–6 предложений, {lo}–{hi} символов;",
...
def _style_block_ru(style: str) -> str:
    ...
    m = {
        ...
        "cb-economics-brief": (
            ...
            f"post: 2–3 абзаца (всего 4–6 предложений, {lo}–{hi} символов). "
            "Структура: что произошло → контекст и механизм → завершённый итог для читателя. "
